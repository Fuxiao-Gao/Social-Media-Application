...
const PinDetail = ({ user }) => {
  ...
  // use useParams to get the pinId from the url
  ...
  // should call useEffect before all the return statements
  //because we want to fetch the pin details before we render the component 
  useEffect(() => { 
    fetchPinDetails();
  }, [pinId])
      ...
      <div className='w-full p-5 flex-1 xl: min-w-620'>
        ...
        <div className='flex flex-wrap mt-6 gap-3'>
          ...
          <button
            type='button'
            onClick={addComment}
              className='bg-[#99592A] text-white rounded-full px-6 py-2 font-semibold text-base'
          >
